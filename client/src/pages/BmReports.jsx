...
export default function BmReports({ user }) {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-5 py-10">
      ...
      <div className="text-sm mb-6" style={{ color: "#6B7280" }}>Одобренные отчёты медпредов вашей группы</div>
        ...
        <div className="rounded-2xl overflow-x-auto" style={{ border: "1px solid #E4E7F0" }}>
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              {reports.length === 0 && <tr><td colSpan={4} className="px-4 py-6 text-center" style={{ color: "#6B7280" }}>Пока нет одобренных отчётов</td></tr>}
            </tbody>
          </table>
        </div>
      )}
